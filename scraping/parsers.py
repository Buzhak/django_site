...
def hh(url_serching, city=None, language=None):
    url = url_serching
        ...
        if resp.status_code == 200:
            ...
            if main_div:
                ...
                for div in div_list:
                    ...
                    # if logo == None:
                    #     logo = 'Нет логотипа'
                    jobs.append({'url': href, 'title': title, 'company': company_name, 'description': context, 'salary': salary, 'city_id': city, 'language_id': language})
            else:
